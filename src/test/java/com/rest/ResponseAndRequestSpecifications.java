...
public class ResponseAndRequestSpecifications {
    ...
    public void beforeClass() {
        RequestSpecBuilder requestSpecBuilder = new RequestSpecBuilder().setBaseUri("https://e990d5c2-35de-4cf8-ad61-c06f262e6ca3.mock.pstmn.io").addHeader("x-mock-match-request-body", "true")
                .setContentType("application/json;charset=utf-8").log(LogDetail.ALL);
        RestAssured.requestSpecification = requestSpecBuilder.build();

        ResponseSpecBuilder responseSpecBuilder = new ResponseSpecBuilder().expectStatusCode(200).expectContentType("application/json;charset=utf-8").log(LogDetail.ALL);
    ...
    public void validate_post_request_payload_complex_json() {
        ...
        given().body(mainHashMap).when().post("/postComplex").then().spec(customResponseSpecification).assertThat().body("msg", equalTo("success"));
    }
