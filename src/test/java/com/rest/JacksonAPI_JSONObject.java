...
public class JacksonAPI_JSONObject {
    ...
    public void validate_post_request_payload_as_map() throws JsonProcessingException {
        ...
        given().body(mainObjectStr).contentType("application/json;charset=utf-8").when().post("/workspaces").then().spec(customResponseSpecification).assertThat().body("workspace.name",
