...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "intrare_auto_cle", name = "Intrare_auto_cle", hidden = false)
public class Intrare_auto_cleModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<Intrare_auto_cleModelOutput> {
    ...
    @Override()
    public Intrare_auto_cleModelOutput toModel() {
        Intrare_auto_cleModelOutput result = new Intrare_auto_cleModelOutput();
        result.setId(getId());
